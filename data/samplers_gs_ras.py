...
class GraphSampler_RAS(Sampler):
    def __init__(self, data_source, model=None, batch_size=64, num_instances=4, transform_train=None, epoch=0, seed=0, center=None, dim_feature=4096):
    ...
    def calc_distance(self, dataset):
        ...
        features = extract_features(model, data_loader, self.dim_feature)
